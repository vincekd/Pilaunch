...
#keywords-- these will only be activated by putting them in, followed by a space
calculator = "c" #"calc"
web = "u" #"url"
websearch = "w" #"web"
sudo = "su"
...
preferredApps = ["chromium", "urxvt", "pidgin", "xbindkeys_config", "google-chrome", "lxappearance", "wicd-curses", "emacs", "susplock.py", "slock", "thunar", "ncmpcpp"]

#whether or not to use connect to mpd
mpd = True
mpdcon = {'host':"/home/vince/.mpd/socket", 'port':"6600"}
